...
mod tests {
    ...
    fn target_language_defaults_to_english_when_config_is_blank() {
        let config = PersistentConfig {
            ...
            auto_sync_model: "qwen3-asr-0.6b-q8_0.gguf".to_string(),
            auto_sync_aligner_model: "qwen3-forced-aligner-0.6b-q4_k_m.gguf".to_string(),
            auto_sync_save_policy: "auto_high_confidence".to_string(),
            auto_sync_confidence_threshold: 0.82,
